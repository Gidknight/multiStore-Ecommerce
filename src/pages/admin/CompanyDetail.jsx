...
import { getSingleCompany } from '../../services/adminServices'
...
const CompanyDetail = () => {
  ...
  // console.log(Number(params.id));
   ...
   useEffect(() => {
    ...
    getProductsOfCompany(id, setProducts)
  }, [])
  const options = [
    {
      id:1,
  ...
  return (
    <section className="m-2 md:m-5 mt-2 pt-20 md:pt-10 md:p-10 bg-white rounded-3xl">
